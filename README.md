...
```
kubectl apply -f https://github.com/riverbed/riverbed-operator/releases/download/v1.0.0/riverbed-operator.yaml
```
...
```
kubectl create -f https://github.com/riverbed/riverbed-operator/releases/download/v1.0.0/riverbed_configuration.yaml --namespace=riverbed-operator --edit
```
