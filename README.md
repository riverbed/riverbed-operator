...
```
kubectl apply -f https://raw.githubusercontent.com/riverbed/riverbed-operator/v1.0.0/riverbed-operator.yaml
```
...
```
kubectl create -f https://raw.githubusercontent.com/riverbed/riverbed-operator/v1.0.0/riverbed_configuration.yaml --namespace=riverbed-operator --edit
```
